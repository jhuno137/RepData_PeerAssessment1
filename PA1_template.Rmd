...
|-|--------|:---------:|:-------:|  
|Median|`r as.integer(median.na)`|`r as.integer(median.nona)`|`r as.integer(median.nona - median.na)`|  
|Mean | `r as.integer(mean.na)` |`r as.integer(mean.nona)` | `r as.integer(mean.nona - mean.na)`|  
